...
// useEffect(() => {
//     // const sessionMilestones = JSON.parse(
//     //     sessionStorage.getItem("milestones")!
//     // );
//     const milestone = user!.milestones.filter((item: any) => {
//         return item._id == paramId;
//     });
//     console.log(milestone[0]);
//     setTitle(milestone[0].title);
//     setDescription(milestone[0].description);
//     setDeadline(
//         new Date(milestone[0].deadline).toLocaleDateString(undefined, {
//             month: "numeric",
//             day: "numeric",
//             year: "numeric",
//         })
//     );
//     setStatus(milestone[0].status);
//     setTags(milestone[0].tags);
//     setTags(milestone[0].owner);
//     setcollaborators(milestone[0].collaborators);
// }, []);
...
//     console.log("milestone edit submitted");
// try {
...
//         collaborators,
//     })) as Milestone;
//     const sessionMilestones: Milestone[] = JSON.parse(
//         sessionStorage.getItem("milestones")!
//     );
//     console.log(sessionMilestones);
//     // console.log(paramId, sessionMilestones[0]._id);
//     let index = 0;
//     for (let i = 0; i < sessionMilestones.length; i++) {
//         if (sessionMilestones[i]._id == paramId) {
//             index = i;
//         }
//     }
//     console.log(index);
//     // const mIndex = sessionMilestones.findIndex((item: any) => {
//     //     item._id === paramId;
//     // });
//     // console.log(paramId, mIndex);

//     sessionMilestones[index] = updatedMilestone;

//     sessionStorage.setItem(
//         "milestones",
//         JSON.stringify(sessionMilestones)
//     );
//     navigate("/dashboard");
// } catch (error) {
...
// import BuildClient from "@/src/api/buildClient";
